<template>
 <q-layout ref="layout">
   <q-toolbar slot="header">
     ...
     <q-btn flat round @click="goTo('projects')" v-show="authenticated">
       <q-icon name="work" />
       <q-tooltip anchor="bottom middle" self="top middle" :offset="[0, 20]">Projects</q-tooltip>
     </q-btn>
     <q-btn flat round @click="goTo('times')" v-show="authenticated">
       <q-icon name="timer" />
       <q-tooltip anchor="bottom middle" self="top middle" :offset="[0, 20]">Times</q-tooltip>
     </q-btn>
   ...
   <div slot="left" ref="menu" v-if="authenticated">
     ...
     <q-side-link item to="/times">
       <q-item-side icon="timer" />
       <q-item-main label="Times"/>
     </q-side-link>
     <q-side-link item to="/projects">
